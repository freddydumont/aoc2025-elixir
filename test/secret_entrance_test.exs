defmodule SecretEntranceTest do
  ...
  test "returns the correct count for part 1 full" do
    assert SecretEntrance.count_dial_at_zero("lib/day1_secret_entrance/inputs/day1.txt") == 1129
  end
  ...
  test "returns the correct count for part 2 full" do
    assert SecretEntrance.count_dial_past_zero("lib/day1_secret_entrance/inputs/day1.txt") ==
             6638
  end
end
